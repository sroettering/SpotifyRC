...
/**
 * Created by sroettering on 21.04.16.
 */
public class PlaylistsListAdapter extends ArrayAdapter<PlaylistSimple> {

    private final Context context;
    private LayoutInflater inflater;
    private List<PlaylistSimple> data;
    private HashMap<Integer, Bitmap> bitmaps;

    public PlaylistsListAdapter(Context context, List<PlaylistSimple> data) {
    ...
    public void updateData(List<PlaylistSimple> newData) {
        this.data = newData;
