...
package com.hci.sroettering.spotifyrc.wiigee.util;
...
import com.hci.sroettering.spotifyrc.wiigee.logic.GestureModel;
import com.hci.sroettering.spotifyrc.wiigee.logic.HMM;
import com.hci.sroettering.spotifyrc.wiigee.logic.Quantizer;
...
public class FileIO {
	...
	public static GestureModel readFromFile(String name) {
		try {
			...
			File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + directoryName, name + ".txt");
